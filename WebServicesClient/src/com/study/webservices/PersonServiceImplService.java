 ...
 * 
 */
@WebServiceClient(name = "PersonServiceImplService", targetNamespace = "http://webservices.study.com/", wsdlLocation = "http://localhost:8882/ws/person?WSDL")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICEIMPLSERVICE_QNAME = new QName("http://webservices.study.com/", "PersonServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8882/ws/person?WSDL");
    ...
    public PersonService getPersonServiceImplPort() {
        return super.getPort(new QName("http://webservices.study.com/", "PersonServiceImplPort"), PersonService.class);
    }
    ...
    public PersonService getPersonServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservices.study.com/", "PersonServiceImplPort"), PersonService.class, features);
    }
